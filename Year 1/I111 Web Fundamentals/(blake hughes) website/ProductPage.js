...
//new row assigned the add to cart price (insert cell is putting in a <td>)
...
new_row.insertCell(1).innerHTML = "<a href='#/' onclick='deleteRow(this)' id=''>delete</a>";
...
//v will hold the price 
var v = cartArray [i];
//x will be array item number matching price to be deleted 
